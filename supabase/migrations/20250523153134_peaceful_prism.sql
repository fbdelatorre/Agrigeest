...
BEGIN
  ...
  -- If invitation exists but is already used, return used error
  ...
  -- If invitation exists but is expired, return expired error
  ...
  -- If institution doesn't exist anymore, return error
  IF invitation_record.institution_id IS NULL OR invitation_record.institution_name IS NULL THEN
    RETURN json_build_object(
      'valid', false,
      'type', 'error',

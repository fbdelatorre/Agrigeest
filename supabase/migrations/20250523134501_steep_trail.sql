...
BEGIN
  ...
  BEGIN
    ...
    SET 
      ...
      email = user_record.email  -- Save user's email
    WHERE id = user_id
    RETURNING *;  -- Make sure the update happened

    -- If user profile wasn't updated, something went wrong
    IF NOT FOUND THEN
    ...
    -- If invitation wasn't updated, something went wrong
    IF NOT FOUND THEN

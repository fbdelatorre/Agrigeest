...
BEGIN
  ...
  RAISE LOG 'Validating invitation code: %, Status: %', clean_code, invitation_record.status_code;
...
BEGIN
  ...
  BEGIN
    ...
    RAISE LOG 'Join attempt - Code: %, User: %, Status: %', 
      clean_code, user_id, invitation_record.status_code;
    ...
    IF invitation_record.status_code != 'VALID_CODE' THEN
      RETURN json_build_object(
        ...
        'message', CASE invitation_record.status_code
          WHEN 'INVALID_CODE' THEN 'The invitation code you entered is invalid'

...
-- Drop join_institution function as well
DROP FUNCTION IF EXISTS public.join_institution(uuid, text);
DROP FUNCTION IF EXISTS auth.join_institution(uuid, text);
DROP FUNCTION IF EXISTS storage.join_institution(uuid, text);
DROP FUNCTION IF EXISTS realtime.join_institution(uuid, text);
